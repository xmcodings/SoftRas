...
def main():
    ...
    parser.add_argument('-i', '--filename-input', type=str,
                        default=os.path.join(data_dir, 'obj', 'cube', 'cube.obj'))
    parser.add_argument('-o', '--output-dir', type=str,
                        default=os.path.join(data_dir, 'results', 'output_render'))
    args = parser.parse_args()

    # other settings
    camera_distance = 4.732
    elevation = 30
    azimuth = 0
    ...
    writer = imageio.get_writer(os.path.join(args.output_dir, 'cube_rotation.gif'), mode='I')
    ...
    writer = imageio.get_writer(os.path.join(args.output_dir, 'cube_bluring.gif'), mode='I')
    ...
    mesh.save_obj(os.path.join(args.output_dir, 'cube_saved.obj'), save_texture=True)
